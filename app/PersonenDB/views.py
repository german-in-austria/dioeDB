...
def maske(request):
	...
	aufgabenform = [
		{'titel':'Person','app':'PersonenDB','tabelle':'tbl_personen','id':'person','optionen':['einzeln','elementFrameless'],
		 ...
		 'feldoptionen':{'nachname':{'label_col':2,'input_col':4},'vorname':{'label_col':2,'input_col':4,'nl':True},'geb_datum':{'label_col':2,'input_col':4},'weiblich':{'label':'Geschlecht','fxtype':{'type':'select','select':[{'title':'k.A.','value':None},{'title':'maennlich','value':False},{'title':'weiblich','value':True}]},'label_col':2,'input_col':4,'nl':True},'akt_wohnort':{'label_col':2,'input_col':10,'label':'Wohnort','nl':True},'strasse_hausnr':{'label_col':2,'input_col':6,'label':'Strasse+Nr'},'plz':{'label_col':1,'input_col':3,'nl':True},'festnetz1':{'label_col':1,'input_col':3,'label':'Telefon&nbsp;1'},'mobil1':{'label_col':1,'input_col':3,'label':'Mobil&nbsp;1'},'mail1':{'label_col':1,'input_col':3,'label':'E&#8209;Mail&nbsp;1','nl':True},'festnetz2':{'label_col':1,'input_col':3,'label':'Telefon&nbsp;2'},'mobil2':{'label_col':1,'input_col':3,'label':'Mobil&nbsp;2'},'mail2':{'label_col':1,'input_col':3,'label':'E&#8209;Mail&nbsp;2','nl':True}},
		  'sub':[
		 	{'titel':'Informant','app':'PersonenDB','tabelle':'tbl_informanten','id':'informant','optionen':['einzeln','elementFrameless'],
		 	 'felder':['+id','|id_person=parent:id','inf_sigle','pretest','inf_gruppe','eignung','geburtsort','inf_ort','kompetenz_d','haeufigkeit_d','kompetenz_s','haeufigkeit_s','akquiriert_am','kontakt_durch'],
			 'feldoptionen':{'inf_sigle':{'label_col':2,'input_col':4,'label':'GWP Sigle'},'pretest':{'label_col':2,'input_col':4,'nl':True},'inf_gruppe':{'label':'Inf. Gruppe','label_col':2,'input_col':4},'eignung':{'label_col':2,'input_col':4,'nl':True},'geburtsort':{'label_col':2,'input_col':4},'inf_ort':{'label_col':2,'input_col':4,'nl':True},'kompetenz_d':{'label_col':2,'input_col':4,'label':'Dialekt&nbsp;Kompetenz'},'haeufigkeit_d':{'label_col':2,'input_col':4,'label':'Dialekt&nbsp;Haeufigkeit','nl':True},'kompetenz_s':{'label_col':2,'input_col':4,'label':'Standard&nbsp;Kompetenz'},'haeufigkeit_s':{'label_col':2,'input_col':4,'label':'Standard&nbsp;Haeufigkeit','nl':True},'akquiriert_am':{'label_col':2,'input_col':4},'kontakt_durch':{'label_col':2,'input_col':4,'label':'Kontaktper.','nl':True}},
		 	 'sub':[
				 ...
				 'feldoptionen':{'id_beruf':{'label_col':2,'input_col':4,'foreignkeytarget':reverse('PersonenDB:berufe')},'ist_aktuell':{'label_col':0,'input_col':3},'ist_ausbildung':{'label_col':0,'input_col':3,'nl':True},'inf_spezifizierung':{'label_col':2,'input_col':10,'nl':True},'von_jahr':{'label_col':2,'input_col':2},'bis_jahr':{'label_col':2,'input_col':2},'dauer_jahr':{'label_col':2,'input_col':2,'label':'Dauer(Jahre)','nl':True}}},
