		  ...
		  'sub':[
			 ...
			 'feldoptionen':{'inf_sigle':{'label_col':2,'input_col':4,'label':'GWP Sigle'},'pretest':{'label_col':2,'input_col':4,'nl':True},'inf_gruppe':{'label':'Inf. Gruppe','label_col':2,'input_col':4},'eignung':{'label_col':2,'input_col':4,'nl':True},'migrationsklasse':{'label_col':2,'input_col':4,'nl':True},'geburtsort':{'label_col':2,'input_col':4},'inf_ort':{'label_col':2,'input_col':4,'nl':True},'familienstand':{'label_col':2,'input_col':4},'ausserhalbwohnort':{'label_col':2,'input_col':4,'nl':True},'ausbildung_max':{'label_col':2,'input_col':4},'ausbildung_spez':{'label_col':2,'input_col':4,'nl':True},'kompetenz_d':{'label_col':2,'input_col':4,'label':'Dialekt&nbsp;Kompetenz'},'haeufigkeit_d':{'label_col':2,'input_col':4,'label':'Dialekt&nbsp;Häufigkeit','nl':True},'kompetenz_s':{'label_col':2,'input_col':4,'label':'Standard&nbsp;Kompetenz'},'haeufigkeit_s':{'label_col':2,'input_col':4,'label':'Standard&nbsp;Häufigkeit','nl':True},'akquiriert_am':{'label_col':2,'input_col':4},'kontakt_durch':{'label_col':2,'input_col':4,'label':'Kontaktper.','nl':True},'kommentar':{'label_col':2,'input_col':10,'nl':True}},
		 	 'sub':[
				 ...
				 'feldoptionen':{'wer':{'label_col':2,'input_col':10,'nl':True},'aufgewachsen':{'label_col':2,'input_col':4},'arbeitsort':{'label_col':2,'input_col':4,'nl':True},'fahrtdauer':{'label_col':8,'input_col':4,'nl':True},'id_ort':{'label_col':2,'input_col':4},'plz':{'label_col':2,'input_col':4,'nl':True},'von_jahr':{'label_col':2,'input_col':2},'bis_jahr':{'label_col':2,'input_col':2},'dauer_jahr':{'label_col':2,'input_col':2,'label':'Dauer(Jahre)','nl':True}}},
				 ...
				 'feldoptionen':{'id_beruf':{'label_col':2,'input_col':10,'foreignkeytarget':reverse('PersonenDB:berufe'),'nl':True},'ist_aktuell':{'label_col':2,'input_col':4},'ist_ausbildung':{'label_col':2,'input_col':4,'nl':True},'inf_spezifizierung':{'label_col':2,'input_col':10,'nl':True},'von_jahr':{'label_col':2,'input_col':2},'bis_jahr':{'label_col':2,'input_col':2},'dauer_jahr':{'label_col':2,'input_col':2,'label':'Dauer(Jahre)','nl':True}}},
