...
class sys_wartungssperre(models.Model):
	...
	text			= models.TextField(					blank=True, null=True, default="Es folgt in Kuerze eine Wartung! Bitte loggen Sie sich rechtzeitig aus!"	, verbose_name="Text")
	stitel			= models.CharField(max_length=255,	blank=True, null=True, default="Laufende Wartung!"			, verbose_name="Sperrtitel")
	stext			= models.TextField(					blank=True, null=True, default="Momentan ist eine Wartung im Gange, bitte versuchen Sie es spaeter noch einmal!"	, verbose_name="Sperrtext")
