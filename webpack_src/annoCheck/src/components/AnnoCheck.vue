  ...
  data () {
    return {
      ...
      tabellenfelder: {
        ...
        'aSaetze': { show: false, displayName: 'Sätze - Text', dontSort: true },
        'aOrtho': { show: true, displayName: 'Sätze - Ortho / Text', dontSort: true },
        'aTokensFallback': { show: true, displayName: 'Ausgewählte Tokens - Text / Ortho / Phon', dontSort: true },
        'aTokensText': { show: false, displayName: 'Ausgewählte Tokens - Text', dontSort: true },
